...
class ChannelClassifier {
    ...
    buildRules() {
        return [
            ...
            { pattern: /^发现之旅/, category: '央视频道', sortKey: 'CCTV发现之旅' },
            { pattern: /^老故事/, category: '央视频道', sortKey: 'CCTV老故事' },
            { pattern: /^中学生/, category: '央视频道', sortKey: 'CCTV中学生' },
            { pattern: /^中国教育/, category: '央视频道', sortKey: 'CETV1' },
            { pattern: /^CETV/, category: '央视频道', sortKey: 'CETV' },
            { pattern: /^CT4/, category: '央视频道', sortKey: 'CCTV4美洲' },
            ...
            { pattern: /^游戏风云/, category: '上海频道', sortKey: '上海游戏风云', province: '上海' },
            { pattern: /^法治天地/, category: '上海频道', sortKey: '上海法治天地', province: '上海' },
            { pattern: /^都市频道/, category: '上海频道', sortKey: '上海都市', province: '上海' },
            { pattern: /^生活时尚/, category: '上海频道', sortKey: '上海生活时尚', province: '上海' },
            { pattern: /^金色频道/, category: '上海频道', sortKey: '上海金色', province: '上海' },
            { pattern: /^欢笑剧场/, category: '上海频道', sortKey: '上海欢笑剧场', province: '上海' },
            { pattern: /^纪实人文/, category: '上海频道', sortKey: '上海纪实人文', province: '上海' },
            { pattern: /^新闻综合/, category: '上海频道', sortKey: '上海新闻综合', province: '上海' },
            { pattern: /^第一财经/, category: '上海频道', sortKey: '上海第一财经', province: '上海' },
            // 广东/深圳
            ...
            { pattern: /^杭州/, category: '浙江频道', sortKey: '浙江杭州', province: '浙江' },
            { pattern: /^宁波/, category: '浙江频道', sortKey: '浙江宁波', province: '浙江' },
            { pattern: /^温州/, category: '浙江频道', sortKey: '浙江温州', province: '浙江' },
            { pattern: /^绍兴/, category: '浙江频道', sortKey: '浙江绍兴', province: '浙江' },
            { pattern: /^嘉兴/, category: '浙江频道', sortKey: '浙江嘉兴', province: '浙江' },
            { pattern: /^金华/, category: '浙江频道', sortKey: '浙江金华', province: '浙江' },
            { pattern: /^台州/, category: '浙江频道', sortKey: '浙江台州', province: '浙江' },
            { pattern: /^湖州/, category: '浙江频道', sortKey: '浙江湖州', province: '浙江' },
            { pattern: /^丽水/, category: '浙江频道', sortKey: '浙江丽水', province: '浙江' },
            { pattern: /^衢州/, category: '浙江频道', sortKey: '浙江衢州', province: '浙江' },
            { pattern: /^舟山/, category: '浙江频道', sortKey: '浙江舟山', province: '浙江' },
            { pattern: /^嵊泗/, category: '浙江频道', sortKey: '浙江嵊泗', province: '浙江' },
            { pattern: /^普陀/, category: '浙江频道', sortKey: '浙江普陀', province: '浙江' },
            { pattern: /^之江/, category: '浙江频道', sortKey: '浙江之江', province: '浙江' },
            // 江苏
            ...
            { pattern: /^家庭影院/, category: '付费频道', sortKey: 'CHC家庭影院' },
            { pattern: /^动作电影/, category: '付费频道', sortKey: 'CHC动作电影' },
            ...
            { pattern: /^熊猫频道/, category: '付费频道', sortKey: '熊猫频道' },
            { pattern: /^高清大片/, category: '付费频道', sortKey: '高清大片' },
            { pattern: /^经典电影/, category: '付费频道', sortKey: '经典电影' },
            { pattern: /^军事大片/, category: '付费频道', sortKey: '军事大片' },
            { pattern: /^热剧联播/, category: '付费频道', sortKey: '热剧联播' },
            { pattern: /^赛事经典/, category: '付费频道', sortKey: '赛事经典' },
            { pattern: /^体坛名汇/, category: '付费频道', sortKey: '体坛名汇' },
            { pattern: /^新片映厅/, category: '付费频道', sortKey: '新片映厅' },
            { pattern: /^Y\+剧场/, category: '付费频道', sortKey: 'Y+剧场' },
            { pattern: /^四海钓鱼/, category: '付费频道', sortKey: '四海钓鱼' },
            { pattern: /^风云音乐/, category: '付费频道', sortKey: '风云音乐' },
            { pattern: /^风云剧场/, category: '付费频道', sortKey: '风云剧场' },
            { pattern: /^世界地理/, category: '付费频道', sortKey: '世界地理' },
            { pattern: /^兵器科技/, category: '付费频道', sortKey: '兵器科技' },
            { pattern: /^怀旧剧场/, category: '付费频道', sortKey: '怀旧剧场' },
            { pattern: /^女性时尚/, category: '付费频道', sortKey: '女性时尚' },
            { pattern: /^摄影频道/, category: '付费频道', sortKey: '摄影频道' },
        ];
    }
