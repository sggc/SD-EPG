...
// === NewTV ===
            ...
            // === 山东 ===
            { pattern: /^QTV1/, logo: '山东/QTV1.png', desc: 'QTV1', priority: 25 },
            { pattern: /^QTV2/, logo: '山东/QTV2.png', desc: 'QTV2', priority: 25 },
            { pattern: /^QTV3/, logo: '山东/QTV3.png', desc: 'QTV3', priority: 25 },
            { pattern: /^QTV4/, logo: '山东/QTV4.png', desc: 'QTV4', priority: 25 },
            { pattern: /^QTV5/, logo: '山东/QTV5.png', desc: 'QTV5', priority: 25 },
            { pattern: /^QTV6/, logo: '山东/QTV6.png', desc: 'QTV6', priority: 25 },
            { pattern: /^东营/, logo: '山东/东营.png', desc: '东营', priority: 20 },
            { pattern: /^东营广饶/, logo: '山东/东营广饶.png', desc: '东营广饶', priority: 25 },
            { pattern: /^临沂临沭/, logo: '山东/临沂临沭.png', desc: '临沂临沭', priority: 25 },
            { pattern: /^临沂兰陵/, logo: '山东/临沂兰陵.png', desc: '临沂兰陵', priority: 25 },
            { pattern: /^临沂沂水/, logo: '山东/临沂沂水.png', desc: '临沂沂水', priority: 25 },
            { pattern: /^临沂河东/, logo: '山东/临沂河东.png', desc: '临沂河东', priority: 25 },
            { pattern: /^临沂莒南/, logo: '山东/临沂莒南.png', desc: '临沂莒南', priority: 25 },
            { pattern: /^临沂蒙阴/, logo: '山东/临沂蒙阴.png', desc: '临沂蒙阴', priority: 25 },
            { pattern: /^威海/, logo: '山东/威海.png', desc: '威海', priority: 20 },
            { pattern: /^威海乳山/, logo: '山东/威海乳山.png', desc: '威海乳山', priority: 25 },
            { pattern: /^威海文登/, logo: '山东/威海文登.png', desc: '威海文登', priority: 25 },
            { pattern: /^威海荣成/, logo: '山东/威海荣成.png', desc: '威海荣成', priority: 25 },
            { pattern: /^德州临邑/, logo: '山东/德州临邑.png', desc: '德州临邑', priority: 25 },
            { pattern: /^德州夏津/, logo: '山东/德州夏津.png', desc: '德州夏津', priority: 25 },
            { pattern: /^德州宁津/, logo: '山东/德州宁津.png', desc: '德州宁津', priority: 25 },
            { pattern: /^德州平原/, logo: '山东/德州平原.png', desc: '德州平原', priority: 25 },
            { pattern: /^德州新闻/, logo: '山东/德州新闻.png', desc: '德州新闻', priority: 25 },
            { pattern: /^德州武城/, logo: '山东/德州武城.png', desc: '德州武城', priority: 25 },
            { pattern: /^德州生活/, logo: '山东/德州生活.png', desc: '德州生活', priority: 25 },
            { pattern: /^德州禹城/, logo: '山东/德州禹城.png', desc: '德州禹城', priority: 25 },
            { pattern: /^德州陵城/, logo: '山东/德州陵城.png', desc: '德州陵城', priority: 25 },
            { pattern: /^德州齐河/, logo: '山东/德州齐河.png', desc: '德州齐河', priority: 25 },
            { pattern: /^日照/, logo: '山东/日照.png', desc: '日照', priority: 20 },
            { pattern: /^日照五莲/, logo: '山东/日照五莲.png', desc: '日照五莲', priority: 25 },
            { pattern: /^日照公共/, logo: '山东/日照公共.png', desc: '日照公共', priority: 25 },
            { pattern: /^日照岚山/, logo: '山东/日照岚山.png', desc: '日照岚山', priority: 25 },
            { pattern: /^日照新闻/, logo: '山东/日照新闻.png', desc: '日照新闻', priority: 25 },
            { pattern: /^日照科教/, logo: '山东/日照科教.png', desc: '日照科教', priority: 25 },
            { pattern: /^日照莒县/, logo: '山东/日照莒县.png', desc: '日照莒县', priority: 25 },
            { pattern: /^枣庄/, logo: '山东/枣庄.png', desc: '枣庄', priority: 20 },
            { pattern: /^枣庄台儿庄/, logo: '山东/枣庄台儿庄.png', desc: '枣庄台儿庄', priority: 25 },
            { pattern: /^枣庄山亭/, logo: '山东/枣庄山亭.png', desc: '枣庄山亭', priority: 25 },
            { pattern: /^枣庄峄城/, logo: '山东/枣庄峄城.png', desc: '枣庄峄城', priority: 25 },
            { pattern: /^枣庄市中/, logo: '山东/枣庄市中.png', desc: '枣庄市中', priority: 25 },
            { pattern: /^枣庄滕州/, logo: '山东/枣庄滕州.png', desc: '枣庄滕州', priority: 25 },
            { pattern: /^枣庄薛城/, logo: '山东/枣庄薛城.png', desc: '枣庄薛城', priority: 25 },
            { pattern: /^泰安东平/, logo: '山东/泰安东平.png', desc: '泰安东平', priority: 25 },
            { pattern: /^泰安东平2/, logo: '山东/泰安东平2.png', desc: '泰安东平2', priority: 25 },
            { pattern: /^泰安东平民生/, logo: '山东/泰安东平民生.png', desc: '泰安东平民生', priority: 25 },
            { pattern: /^泰安宁阳/, logo: '山东/泰安宁阳.png', desc: '泰安宁阳', priority: 25 },
            { pattern: /^泰安宁阳一套/, logo: '山东/泰安宁阳一套.png', desc: '泰安宁阳一套', priority: 25 },
            { pattern: /^泰安宁阳二套/, logo: '山东/泰安宁阳二套.png', desc: '泰安宁阳二套', priority: 25 },
            { pattern: /^泰安岱岳/, logo: '山东/泰安岱岳.png', desc: '泰安岱岳', priority: 25 },
            { pattern: /^泰安岱岳2/, logo: '山东/泰安岱岳2.png', desc: '泰安岱岳2', priority: 25 },
            { pattern: /^泰安新泰/, logo: '山东/泰安新泰.png', desc: '泰安新泰', priority: 25 },
            { pattern: /^泰安新泰2/, logo: '山东/泰安新泰2.png', desc: '泰安新泰2', priority: 25 },
            { pattern: /^泰安新泰乡村/, logo: '山东/泰安新泰乡村.png', desc: '泰安新泰乡村', priority: 25 },
            { pattern: /^泰安新泰乡村2/, logo: '山东/泰安新泰乡村2.png', desc: '泰安新泰乡村2', priority: 25 },
            { pattern: /^泰安泰山/, logo: '山东/泰安泰山.png', desc: '泰安泰山', priority: 25 },
            { pattern: /^泰安泰山2/, logo: '山东/泰安泰山2.png', desc: '泰安泰山2', priority: 25 },
            { pattern: /^泰安经济生活/, logo: '山东/泰安经济生活.png', desc: '泰安经济生活', priority: 25 },
            { pattern: /^泰安综合/, logo: '山东/泰安综合.png', desc: '泰安综合', priority: 25 },
            { pattern: /^泰安肥城/, logo: '山东/泰安肥城.png', desc: '泰安肥城', priority: 25 },
            { pattern: /^泰安肥城2/, logo: '山东/泰安肥城2.png', desc: '泰安肥城2', priority: 25 },
            { pattern: /^泰安肥城生活/, logo: '山东/泰安肥城生活.png', desc: '泰安肥城生活', priority: 25 },
            { pattern: /^济南历城/, logo: '山东/济南历城.png', desc: '济南历城', priority: 25 },
            { pattern: /^济南商河/, logo: '山东/济南商河.png', desc: '济南商河', priority: 25 },
            { pattern: /^济南娱乐/, logo: '山东/济南娱乐.png', desc: '济南娱乐', priority: 25 },
            { pattern: /^济南少儿/, logo: '山东/济南少儿.png', desc: '济南少儿', priority: 25 },
            { pattern: /^济南平阴/, logo: '山东/济南平阴.png', desc: '济南平阴', priority: 25 },
            { pattern: /^济南教育/, logo: '山东/济南教育.png', desc: '济南教育', priority: 25 },
            { pattern: /^济南文旅体育/, logo: '山东/济南文旅体育.png', desc: '济南文旅体育', priority: 25 },
            { pattern: /^济南新闻/, logo: '山东/济南新闻.png', desc: '济南新闻', priority: 25 },
            { pattern: /^济南新闻综合/, logo: '山东/济南新闻综合.png', desc: '济南新闻综合', priority: 25 },
            { pattern: /^济南济阳/, logo: '山东/济南济阳.png', desc: '济南济阳', priority: 25 },
            { pattern: /^济南生活/, logo: '山东/济南生活.png', desc: '济南生活', priority: 25 },
            { pattern: /^济南科教/, logo: '山东/济南科教.png', desc: '济南科教', priority: 25 },
            { pattern: /^济南章丘/, logo: '山东/济南章丘.png', desc: '济南章丘', priority: 25 },
            { pattern: /^济南都市/, logo: '山东/济南都市.png', desc: '济南都市', priority: 25 },
            { pattern: /^济南长清/, logo: '山东/济南长清.png', desc: '济南长清', priority: 25 },
            { pattern: /^济南鲁中/, logo: '山东/济南鲁中.png', desc: '济南鲁中', priority: 25 },
            { pattern: /^济宁/, logo: '山东/济宁.png', desc: '济宁', priority: 20 },
            { pattern: /^济宁任城/, logo: '山东/济宁任城.png', desc: '济宁任城', priority: 25 },
            { pattern: /^济宁兖州/, logo: '山东/济宁兖州.png', desc: '济宁兖州', priority: 25 },
            { pattern: /^济宁嘉祥/, logo: '山东/济宁嘉祥.png', desc: '济宁嘉祥', priority: 25 },
            { pattern: /^济宁曲阜/, logo: '山东/济宁曲阜.png', desc: '济宁曲阜', priority: 25 },
            { pattern: /^济宁梁山/, logo: '山东/济宁梁山.png', desc: '济宁梁山', priority: 25 },
            { pattern: /^济宁汶上/, logo: '山东/济宁汶上.png', desc: '济宁汶上', priority: 25 },
            { pattern: /^济宁邹城/, logo: '山东/济宁邹城.png', desc: '济宁邹城', priority: 25 },
            { pattern: /^济宁高新/, logo: '山东/济宁高新.png', desc: '济宁高新', priority: 25 },
            { pattern: /^济宁鱼台/, logo: '山东/济宁鱼台.png', desc: '济宁鱼台', priority: 25 },
            { pattern: /^济阳影视/, logo: '山东/济阳影视.png', desc: '济阳影视', priority: 25 },
            { pattern: /^海洋频道/, logo: '山东/海洋频道.png', desc: '海洋频道', priority: 25 },
            { pattern: /^淄博临淄/, logo: '山东/淄博临淄.png', desc: '淄博临淄', priority: 25 },
            { pattern: /^淄博周村/, logo: '山东/淄博周村.png', desc: '淄博周村', priority: 25 },
            { pattern: /^淄博张店/, logo: '山东/淄博张店.png', desc: '淄博张店', priority: 25 },
            { pattern: /^淄博影视/, logo: '山东/淄博影视.png', desc: '淄博影视', priority: 25 },
            { pattern: /^淄博文旅/, logo: '山东/淄博文旅.png', desc: '淄博文旅', priority: 25 },
            { pattern: /^淄博新闻/, logo: '山东/淄博新闻.png', desc: '淄博新闻', priority: 25 },
            { pattern: /^淄博桓台/, logo: '山东/淄博桓台.png', desc: '淄博桓台', priority: 25 },
            { pattern: /^淄博民生/, logo: '山东/淄博民生.png', desc: '淄博民生', priority: 25 },
            { pattern: /^淄博沂源/, logo: '山东/淄博沂源.png', desc: '淄博沂源', priority: 25 },
            { pattern: /^淄博淄川/, logo: '山东/淄博淄川.png', desc: '淄博淄川', priority: 25 },
            { pattern: /^淄博高青/, logo: '山东/淄博高青.png', desc: '淄博高青', priority: 25 },
            { pattern: /^滨州/, logo: '山东/滨州.png', desc: '滨州', priority: 20 },
            { pattern: /^滨州惠民/, logo: '山东/滨州惠民.png', desc: '滨州惠民', priority: 25 },
            { pattern: /^滨州无棣/, logo: '山东/滨州无棣.png', desc: '滨州无棣', priority: 25 },
            { pattern: /^滨州沾化/, logo: '山东/滨州沾化.png', desc: '滨州沾化', priority: 25 },
            { pattern: /^滨州邹平/, logo: '山东/滨州邹平.png', desc: '滨州邹平', priority: 25 },
            { pattern: /^滨州阳信/, logo: '山东/滨州阳信.png', desc: '滨州阳信', priority: 25 },
            { pattern: /^潍坊寿光/, logo: '山东/潍坊寿光.png', desc: '潍坊寿光', priority: 25 },
            { pattern: /^潍坊影视/, logo: '山东/潍坊影视.png', desc: '潍坊影视', priority: 25 },
            { pattern: /^潍坊文旅/, logo: '山东/潍坊文旅.png', desc: '潍坊文旅', priority: 25 },
            { pattern: /^潍坊新闻/, logo: '山东/潍坊新闻.png', desc: '潍坊新闻', priority: 25 },
            { pattern: /^潍坊生活/, logo: '山东/潍坊生活.png', desc: '潍坊生活', priority: 25 },
            { pattern: /^潍坊诸城/, logo: '山东/潍坊诸城.png', desc: '潍坊诸城', priority: 25 },
            { pattern: /^潍坊青州/, logo: '山东/潍坊青州.png', desc: '潍坊青州', priority: 25 },
            { pattern: /^潍坊高新/, logo: '山东/潍坊高新.png', desc: '潍坊高新', priority: 25 },
            { pattern: /^烟台/, logo: '山东/烟台.png', desc: '烟台', priority: 20 },
            { pattern: /^烟台招远/, logo: '山东/烟台招远.png', desc: '烟台招远', priority: 25 },
            { pattern: /^烟台栖霞/, logo: '山东/烟台栖霞.png', desc: '烟台栖霞', priority: 25 },
            { pattern: /^烟台海阳/, logo: '山东/烟台海阳.png', desc: '烟台海阳', priority: 25 },
            { pattern: /^烟台牟平/, logo: '山东/烟台牟平.png', desc: '烟台牟平', priority: 25 },
            { pattern: /^烟台蓬莱/, logo: '山东/烟台蓬莱.png', desc: '烟台蓬莱', priority: 25 },
            { pattern: /^烟台长岛/, logo: '山东/烟台长岛.png', desc: '烟台长岛', priority: 25 },
            { pattern: /^烟台龙口/, logo: '山东/烟台龙口.png', desc: '烟台龙口', priority: 25 },
            { pattern: /^聊城/, logo: '山东/聊城.png', desc: '聊城', priority: 20 },
            { pattern: /^聊城东昌/, logo: '山东/聊城东昌.png', desc: '聊城东昌', priority: 25 },
            { pattern: /^聊城东阿/, logo: '山东/聊城东阿.png', desc: '聊城东阿', priority: 25 },
            { pattern: /^聊城临清/, logo: '山东/聊城临清.png', desc: '聊城临清', priority: 25 },
            { pattern: /^聊城冠县/, logo: '山东/聊城冠县.png', desc: '聊城冠县', priority: 25 },
            { pattern: /^聊城茌平/, logo: '山东/聊城茌平.png', desc: '聊城茌平', priority: 25 },
            { pattern: /^聊城莘县/, logo: '山东/聊城莘县.png', desc: '聊城莘县', priority: 25 },
            { pattern: /^菏泽/, logo: '山东/菏泽.png', desc: '菏泽', priority: 20 },
            { pattern: /^菏泽东明/, logo: '山东/菏泽东明.png', desc: '菏泽东明', priority: 25 },
            { pattern: /^菏泽单县/, logo: '山东/菏泽单县.png', desc: '菏泽单县', priority: 25 },
            { pattern: /^菏泽定陶/, logo: '山东/菏泽定陶.png', desc: '菏泽定陶', priority: 25 },
            { pattern: /^菏泽巨野/, logo: '山东/菏泽巨野.png', desc: '菏泽巨野', priority: 25 },
            { pattern: /^菏泽郓城/, logo: '山东/菏泽郓城.png', desc: '菏泽郓城', priority: 25 },
            { pattern: /^菏泽鄄城/, logo: '山东/菏泽鄄城.png', desc: '菏泽鄄城', priority: 25 },
            { pattern: /^青岛崂山/, logo: '山东/青岛崂山.png', desc: '青岛崂山', priority: 25 },
            { pattern: /^青岛平度/, logo: '山东/青岛平度.png', desc: '青岛平度', priority: 25 },
            { pattern: /^青岛胶州/, logo: '山东/青岛胶州.png', desc: '青岛胶州', priority: 25 },
            { pattern: /^青岛莱西/, logo: '山东/青岛莱西.png', desc: '青岛莱西', priority: 25 },
            { pattern: /^青岛黄岛/, logo: '山东/青岛黄岛.png', desc: '青岛黄岛', priority: 25 },
